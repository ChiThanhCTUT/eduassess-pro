...
export const initialQuestions: Question[] = [
  {
    ...
    options: ['2x * cos(x^2)', 'cos(x^2)', '2 * sin(x) * cos(x)', '-2x * cos(x^2)'],
    correctAnswer: 0,
    topic: 'Giải tích I',
    avgTime: '02:15',
    errorRate: 35.5,
  ...
  },
  {
    ...
    subject: 'Hóa hữu cơ',
    difficulty: 'Dễ',
    options: ['Fluor (F)', 'Oxy (O)', 'Clo (Cl)', 'Cacbon (C)'],
    correctAnswer: 0,
  ...
  },
  {
    id: '#Q-89024',
    content:
      'Định nghĩa định luật thứ hai của nhiệt động lực học và ý nghĩa của nó đối với entropy.',
    subject: 'Vật lý',
    difficulty: 'Trung bình',
    options: [
  ...
  },
  {
    id: '#Q-89026',
    content:
      'Xác định chu trình trong đồ thị có hướng bằng giải thuật tìm kiếm theo chiều sâu (DFS) dựa trên yếu tố nào?',
    subject: 'Toán học',
    difficulty: 'Khó',
    options: [
  ...
  },
  {
    id: '#Q-89027',
    content:
      'Logic tái cân bằng khi xóa nút lá trong cây tìm kiếm nhị phân B-Tree tuân thủ nguyên tắc gì?',
    subject: 'Toán học',
    difficulty: 'Khó',
    options: [
  ...
  },
  {
    id: '#Q-89028',
    content:
      'Trường hợp tốt nhất so với tệ nhất cho chaining trong bảng băm (Hash Maps) lần lượt là gì?',
    subject: 'Toán học',
    difficulty: 'Khó',
    options: [

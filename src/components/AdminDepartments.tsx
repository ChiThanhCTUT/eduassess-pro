              ...
              if (d.id === editingSubject.deptId) {
                return {
                  ...
                  subjects: d.subjects.map(s =>
                    s.code === editingSubject.subject.code ? data : s,
                  ),
                };
              }
              return d;
  ...
  return (
    <div className="space-y-8 animate-fade-in" id="admin-dept-root">
      ...
      <div
        ...
        id="admin-dept-header"
      >
        <div>
          <h1 className="text-3xl font-bold text-[#191c1d]">Quản lý Khoa & Bộ môn</h1>
          <p className="text-sm text-gray-500 mt-1">
            Thiết lập cơ cấu phòng ban, quản lý chương trình học tập và kiểm duyệt hệ thống học
            liệu.
          </p>
        </div>
        <button
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-2 bg-[#f8f9fa] border border-gray-100 rounded-xl p-3 my-4 text-center">
                  <div>
                    ...
                    <p className="text-xs font-bold text-gray-700 mt-1 truncate max-w-[120px] mx-auto">
                      {dept.head}
                    </p>
                  </div>
                  <div>
                ...
                <div className="mt-4 space-y-2.5">
                  <div className="flex justify-between items-center border-b border-gray-100 pb-1.5">
                    <span className="text-xs font-bold text-gray-400 uppercase tracking-wider">
                      Học phần liên kết ({dept.subjects.length})
                    </span>
                    <button
                  ...
                  {dept.subjects.length > 0 ? (
                    <div className="divide-y divide-gray-100 max-h-[160px] overflow-y-auto pr-1">
                      {dept.subjects.map(sub => (
                        <div
                          key={sub.code}
                          className="py-2 flex items-center justify-between text-xs hover:bg-gray-50/50 px-1 rounded transition-colors"
                        >
            ...
            <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
              <div className="flex items-center gap-3">
                <span className="material-symbols-outlined text-[#0058be] text-2xl">
                  {editingDept ? 'edit' : 'domain_add'}
                </span>
                <h2 className="text-lg font-bold text-[#191c1d]">
                  {editingDept ? 'Cập nhật thông tin Khoa' : 'Thành lập Khoa mới'}
                </h2>
              </div>
              <button
                onClick={() => {
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    onChange={e =>
                      setDeptForm(prev => ({ ...prev, teacherCount: Number(e.target.value) }))
                    }
                  />
                </div>
              </div>
        ...
        >
          ...
          <div className="relative bg-white w-full max-w-md rounded-3xl shadow-2xl overflow-hidden flex flex-col">
            <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
              <div className="flex items-center gap-3">
                <span className="material-symbols-outlined text-[#0058be] text-2xl">
                  {editingSubject ? 'edit' : 'add_card'}
                </span>
                <h2 className="text-lg font-bold text-[#191c1d]">
                  {editingSubject ? 'Cập nhật Học phần' : 'Thêm Học phần / Bộ môn'}
                </h2>
              </div>
              <button
                onClick={() => {
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    onChange={e =>
                      setSubForm(prev => ({ ...prev, credits: Number(e.target.value) }))
                    }
                  >
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    onChange={e =>
                      setSubForm(prev => ({ ...prev, questionCount: Number(e.target.value) }))
                    }
                  />
                </div>
              </div>

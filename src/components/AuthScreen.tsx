    ...
    fetch('/api/auth/login', {
      ...
      .then(async res => {
        ...
        if (contentType && contentType.includes('application/json')) {
          ...
          throw new Error(
            errText ||
              `Không thể kết nối với Express Backend (HTTP ${res.status}). Vui lòng đảm bảo bạn đã khởi động Express Server.`,
          );
        }
          ...
          <div className="relative z-10 space-y-8">
            ...
            <div className="space-y-4">
              <h2 className="font-bold text-3xl text-white leading-tight">
                Làm chủ tiềm năng học thuật của bạn
              </h2>
              <p className="text-[#adc6ff] text-sm max-w-md leading-relaxed">
                Trải nghiệm thế hệ tiếp theo của các kỳ thi trực tuyến. An toàn, tin cậy và được
                thiết kế để giúp bạn tập trung vào điều quan trọng nhất — kiến thức của bạn.
              </p>
            </div>
            <div className="pt-4">
          ...
          <div className="w-full max-w-md mx-auto">
            ...
            <div className="space-y-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-gray-600" htmlFor="login-email">
                    Địa chỉ Email trường học
                  </label>
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between items-center">
                    <label className="text-xs font-bold text-gray-600" htmlFor="login-password">
                      Mật khẩu
                    </label>
                    <a
                      href="#forgot"
                      onClick={e => {
                        e.preventDefault();
                        alert('Vui lòng liên hệ với ban CNTT nhà trường để khôi phục mật khẩu.');
                      }}
            ...
            <footer className="mt-10 text-center">
              <p className="text-[11px] text-gray-400 leading-relaxed">
                Hệ thống Bảo mật © 2026 EduAssess Pro.
                <br />

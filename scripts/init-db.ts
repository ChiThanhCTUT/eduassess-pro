...
export async function initializeDatabase() {
  ...
  try {
    ...
    // Indexes
    try { await pool.query("CREATE INDEX idx_users_role ON users (role)"); } catch (e) {}
    try { await pool.query("CREATE INDEX idx_questions_subject ON questions (subject)"); } catch (e) {}
    try { await pool.query("CREATE INDEX idx_exams_subject ON active_exams (subject)"); } catch (e) {}
    try { await pool.query("CREATE INDEX idx_history_user_email ON exam_history (userEmail)"); } catch (e) {}
